...
import { isDefined, GenericChartComponent } from "@reincharts/core";
...
export interface HoverTextNearMouseProps {
    ...
    /** Background fill color for the hover text box. */
    readonly bgFill?: string;
    /** Width of the background box, can be 'auto' or specific pixel value. */
    readonly bgWidth: number | string;
    /** Height of the background box, can be 'auto' or specific pixel value. */
    readonly bgHeight: number | string;
    /** Whether to show the hover text. */
...
export class HoverTextNearMouse extends React.Component<HoverTextNearMouseProps, HoverTextNearMouseState> {
    ...
    public render() {
        ...
        if (text) {
            return <GenericChartComponent svgDraw={this.renderSVG} drawOn={["mousemove", "keydown"]} />;
        } else {
            return null;
        }
    }
    ...
    private readonly renderSVG = (moreProps: any) => {
        const { fontFamily, fontSize, fill, bgFill } = this.props;
        ...
        if (textMetaData !== undefined && isDefined(textMetaData)) {
            ...
            return (
                <g>
                    <rect fill={bgFill} stroke={bgFill} {...rect} />
                    <text
                        ref={this.textNode}
                        fontSize={fontSize}
