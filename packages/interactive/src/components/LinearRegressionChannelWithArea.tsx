...
import { getClosestItemIndexes, getMouseCanvas, GenericChartComponent } from "@reincharts/core";
...
export interface LinearRegressionChannelWithAreaProps {
    ...
    /** Type of linear regression channel calculation method. */
    readonly type:
    ...
    private readonly isHover = (moreProps: any) => {
        ...
        if (onHover !== undefined) {
            ...
            const hovering = yDiffs.reduce(
                (result, diff) => result || isHoveringBasic([x1, y1 + diff], [x2, y2 + diff], mouseXY, tolerance),
                false,
            );
            return hovering;
        }
