...
export interface EachEquidistantChannelProps {
    /** Starting X,Y coordinates for the first point of the equidistant channel. */
    readonly startXY: number[];
    /** Ending X,Y coordinates for the second point of the equidistant channel. */
    readonly endXY: number[];
    /** Optional Y-axis delta value for channel width calculation. */
    readonly dy?: number;
    /** Whether the equidistant channel is interactive (can be dragged/modified). */
    readonly interactive: boolean;
    /** Whether this equidistant channel is currently selected. */
    ...
    /** Visual appearance configuration for the equidistant channel. */
    readonly appearance: {
        ...
        /** Fill color for the first edge control circle. */
        readonly edgeFill: string;
        /** Fill color for the second edge control circle. */
    ...
    /** Optional index identifier for this equidistant channel. */
    readonly index?: number;
    /** Callback fired when the equidistant channel is being dragged. */
    readonly onDrag: (e: React.MouseEvent, index: number | undefined, moreProps: any) => void;
    /** Callback fired when dragging of the equidistant channel is completed. */
            ...
            dy !== undefined && isDefined(dy) ? (
                <g>
                    {this.getEdgeCircle({
                        ...
                        cursor: "reincharts-ns-resize-cursor",
                        fill: edgeFill2,
                        edge: "line2edge1",
                    })}
                    {this.getEdgeCircle({
