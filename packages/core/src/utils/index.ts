 ...
 *
 * Without accessor: returns array[0] or undefined for empty/null arrays.
 * With accessor: returns first element where accessor(element) is defined,
 ...
 *
 * Without accessor: returns array[len-1] or undefined for empty/null arrays.
 * With accessor: returns last element where accessor(element) is defined,
 * or undefined if none found.
 */
...
export function toObject(array: any, iteratee = identity) {
    return array.reduce((returnObj: any, a: any) => {
