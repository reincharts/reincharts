...
export interface ChartProps {
    ...
    readonly zoomAnchor?: (options: IZoomAnchorOptions<IOHLCData, number | Date>) => number | Date;
}
...
export default withOHLCData()(withSize({ style: { minHeight: 400 } })(withDeviceRatio()(Interaction)));
