...
class Tooltips extends React.Component<ChartProps> {
    ...
    public render() {
        const { data: initialData, height, ratio, width, hoverTooltip, ...tooltipProps } = this.props;
            ...
            >
                <Chart id={1} yExtents={this.yExtents}>
                    ...
                    {!hoverTooltip && (
                        <OHLCTooltip
                            origin={[8, 16]}
                            textFill={(d) => (d.close > d.open ? "#26a675ff" : "#e93b3bff")}
                            {...tooltipProps}
                        />
                    )}
                    {hoverTooltip && (
...
export default withOHLCData()(withSize({ style: { minHeight: 400 } })(withDeviceRatio()(Tooltips)));
