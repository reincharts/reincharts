...
import { macd } from "@reincharts/indicators";
import { discontinuousTimeScaleProviderBuilder } from "@reincharts/scales";
import { MACDSeries } from "@reincharts/series";
import { MACDTooltip } from "@reincharts/tooltip";
...
class MACDIndicator extends React.Component<ChartProps> {
    ...
    public render() {
        const { data: initialData, height, ratio, width, ...macdProps } = this.props;
        ...
        return (
            ...
            >
                <Chart id={1} yExtents={yAccessor}>
                    ...
                    <MACDSeries yAccessor={yAccessor} {...macdProps} />
