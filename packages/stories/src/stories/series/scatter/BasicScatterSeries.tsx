...
import { ScatterSeries, CircleMarker } from "@reincharts/series";
...
class BasicScatterSeries extends React.Component<ChartProps> {
    ...
    public render() {
        const { data: initialData, height, ratio, width, ...scatterProps } = this.props;
            ...
            >
                <Chart id={1} yExtents={this.yExtents}>
                    <ScatterSeries
                        ...
                        marker={CircleMarker}
                        markerProps={{ r: radius, ...scatterProps }}
                    />
                    <XAxis />
                    <YAxis />
                </Chart>
...
export default withOHLCData("DAILY")(withSize({ style: { minHeight: 400 } })(withDeviceRatio()(BasicScatterSeries)));
