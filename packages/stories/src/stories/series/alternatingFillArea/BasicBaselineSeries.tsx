...
import { AlternatingFillAreaSeries, AlternatingFillAreaSeriesProps } from "@reincharts/series";
        ...
        return (
            ...
            >
                <Chart id={1} yExtents={this.yExtents}>
                    <AlternatingFillAreaSeries yAccessor={this.yAccessor} {...rest} />
                    <XAxis />
                    <YAxis />
                </Chart>
            </ChartCanvas>
...
export const Daily = withOHLCData()(withSize({ style: { minHeight: 400 } })(withDeviceRatio()(BasicBaselineSeries)));

export const Intraday = withOHLCData("MINUTES")(
    withSize({ style: { minHeight: 400 } })(withDeviceRatio()(BasicBaselineSeries)),
);
