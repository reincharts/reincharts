...
import { AreaSeries, AreaSeriesProps } from "@reincharts/series";
...
export const Daily = withOHLCData()(withSize({ style: { minHeight: 400 } })(withDeviceRatio()(BasicAreaSeries)));

export const Intraday = withOHLCData("MINUTES")(
    withSize({ style: { minHeight: 400 } })(withDeviceRatio()(BasicAreaSeries)),
);
