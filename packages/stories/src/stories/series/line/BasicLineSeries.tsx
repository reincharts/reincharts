...
import { LineSeries, LineSeriesProps } from "@reincharts/series";
...
export const Daily = withOHLCData()(withSize({ style: { minHeight: 400 } })(withDeviceRatio()(BasicLineSeries)));

export const Intraday = withOHLCData("MINUTES")(
    withSize({ style: { minHeight: 400 } })(withDeviceRatio()(BasicLineSeries)),
);
