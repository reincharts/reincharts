...
import { OHLCSeries } from "@reincharts/series";
...
class BasicOHLCSeries extends React.Component<ChartProps> {
    ...
    public render() {
        const { data: initialData, height, ratio, width, ...ohlcProps } = this.props;
...
export const Daily = withOHLCData()(withSize({ style: { minHeight: 400 } })(withDeviceRatio()(BasicOHLCSeries)));

export const Intraday = withOHLCData("MINUTES")(
    withSize({ style: { minHeight: 400 } })(withDeviceRatio()(BasicOHLCSeries)),
);
