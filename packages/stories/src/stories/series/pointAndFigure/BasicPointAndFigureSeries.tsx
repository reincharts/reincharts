...
import { pointAndFigure } from "@reincharts/indicators";
import { discontinuousTimeScaleProviderBuilder } from "@reincharts/scales";
import { PointAndFigureSeries } from "@reincharts/series";
...
class BasicPointAndFigureSeries extends React.Component<ChartProps> {
    ...
    public render() {
        const { data: initialData, height, ratio, width, ...pointProps } = this.props;
        ...
        return (
            ...
            >
                <Chart id={1} yExtents={this.yExtents}>
                    <PointAndFigureSeries {...pointProps} />
                    <XAxis />
                    <YAxis />
                </Chart>
            </ChartCanvas>
...
export const Daily = withOHLCData()(
    withSize({ style: { minHeight: 400 } })(withDeviceRatio()(BasicPointAndFigureSeries)),
);
