...
import { renko } from "@reincharts/indicators";
import { discontinuousTimeScaleProviderBuilder } from "@reincharts/scales";
import { RenkoSeries } from "@reincharts/series";
...
class BasicRenkoSeries extends React.Component<ChartProps> {
    ...
    public render() {
        const { data: initialData, height, ratio, width, ...renkoProps } = this.props;
...
export const Daily = withOHLCData()(withSize({ style: { minHeight: 400 } })(withDeviceRatio()(BasicRenkoSeries)));

export const Intraday = withOHLCData("MINUTES")(
    withSize({ style: { minHeight: 400 } })(withDeviceRatio()(BasicRenkoSeries)),
);
