...
import { heikinAshi } from "@reincharts/indicators";
...
class BasicHeikinAshiSeries extends React.Component<ChartProps> {
    ...
    public render() {
        const { data: initialData, height, ratio, width, ...candleProps } = this.props;
...
export const Daily = withOHLCData()(withSize({ style: { minHeight: 400 } })(withDeviceRatio()(BasicHeikinAshiSeries)));

export const Intraday = withOHLCData("MINUTES")(
    withSize({ style: { minHeight: 400 } })(withDeviceRatio()(BasicHeikinAshiSeries)),
);
