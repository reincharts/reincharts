...
import { first, functor, getAxisCanvas, GenericChartComponent, plotDataLengthBarWidth } from "@reincharts/core";
...
export interface OverlayBarSeriesProps {
    ...
    readonly strokeStyle?: string | ((data: any, y: number) => string);
    /** Width of each bar. */
    readonly width?: any;
    ...
    /** Array of functions to extract y-values from data for multiple bar layers. */
...
export class OverlayBarSeries extends React.Component<OverlayBarSeriesProps> {
    ...
    private readonly getBars = (moreProps: any) => {
        ...
        const { baseAt, fillStyle, strokeStyle, yAccessor } = this.props;
