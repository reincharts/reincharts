...
import { functor, isDefined, getAxisCanvas, GenericChartComponent } from "@reincharts/core";
...
export interface OHLCSeriesProps {
    ...
    readonly yAccessor: (data: any) => IOHLC;
}
...
export class OHLCSeries extends React.Component<OHLCSeriesProps> {
    public static defaultProps = {
        ...
        stroke: (d: any) =>
            isDefined(d.absoluteChange) ? (d.absoluteChange > 0 ? "#26a675ff" : "#e93b3bff") : "#000000",
        strokeWidth: 1,
        clip: true,
    };
